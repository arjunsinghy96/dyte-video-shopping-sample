...
const Meeting: React.FC = () => {
  ...
  const participantJoined = useDyteSelector(
  ...
  meeting.participants.on('*', (el) => {
    console.log(el)
  })
  meeting.self.on('roomJoined', (e) => {
    console.log(e)
  })
  ...
  return (
    <div className="h-screen flex flex-col justify-center">
      <div className="text-center mb-10">
        Please wait! A customer support representative will be assigned shortly.
      </div>
      <div>
...
const UserLiveMeeting: React.FC = () => {
  ...
  const setupDyteMeeting = async () => {
    const resp = await axios.get(`http://localhost:8000/live_shopping/live_requests/${meeting_id}/participants`)
  ...
  return (
    <DyteProvider value={meeting} fallback={<Waiting />}>
      <Meeting></Meeting>
    </DyteProvider>
  )
}

export default UserLiveMeeting
